...
const CustomActionForm: React.FC<CustomActionFormProps> = ({ onCustomAction, isLoading }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 flex gap-3">
      ...
      <button
        type="submit"
        className="px-6 py-3 bg-red-800 text-white font-bold rounded-md hover:bg-red-700 transition-colors duration-200 disabled:bg-red-900/50 disabled:cursor-not-allowed"
